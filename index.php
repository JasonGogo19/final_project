...
<head>
    ...
    <meta name="'viewport" content="width_device-width, initial-scale">
    ...
    <div class="navbar">
        <div class="container">
            ...
            <ul class="nav-links">
                ...
                <li><a href="../final_project/login/login.php">Log in</a></li>
                <li><a href="../final_project/login/register.php">Sign up</a></li>
            </ul>
            <div class="hamburger">
                <span></span>
                <span></span>
